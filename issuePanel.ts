...
class LoadData {
    ...
    reload = (settings: Settings, setHeader) => {
       ...
       Issue.loadIssues((data, status, request) => {
		...
		//setTimeout(this.update(settings), 60000);
		//setTimeout(this.loadContent(settings), 60000);
		//setTimeout(location.reload(),60000);
		//setTimeout(this.reload(settings, setHeader), 60000000000000000000000000000000000000000000);
		//setTimeout(alert("new test"), 10000);
		//this.reload(settings, setHeader);
    }
